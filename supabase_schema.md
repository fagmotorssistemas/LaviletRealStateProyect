...
CREATE TABLE public.appointments (
  ...
  location_type text DEFAULT 'proyecto'::text CHECK (location_type = ANY (ARRAY['oficina'::text, 'proyecto'::text, 'mixto'::text])),
  office_id uuid,
  project_id uuid,
  notes text,
  created_at timestamp with time zone DEFAULT now(),
...
CREATE TABLE public.projects (
  ...
  architects text,
  plan_type text,
  summary_financial_initial_pvp_total numeric,
  summary_financial_min_expected_with_discounts numeric,
