-- Copiar TODO este archivo en SQL Editor de Supabase, rol postgres, y pulsar Run.
-- Instala las funciones y reinicia solo Nataly (Kommo 3928256) en una transaccion.
-- Conserva identidad y respaldo; el historial de Kommo/WhatsApp permanece.
-- Si el worker esta ocupado, esperar unos segundos y ejecutar TODO de nuevo.
BEGIN;
...
BEGIN
 -- Dos identidades autorizadas; nunca aceptar un UUID arbitrario o buscar por nombre.
 CASE p_kommo_id
  ...
  ELSE RAISE EXCEPTION 'Solo se permite reiniciar los contactos de prueba autorizados de Carlos y Nataly.';
 END CASE;
...
COMMENT ON FUNCTION public.lv_reset_lavilet_test_contact(integer) IS 'Reinicio privado con respaldo, limitado a las identidades verificadas de Carlos y Nataly en La Vilet. No envía mensajes ni cambia Kommo.';
