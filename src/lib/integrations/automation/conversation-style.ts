...
export const NATURAL_CONVERSATION_RULES = [
  ...
  'Cuando pregunta por la ubicación del edificio, indique la dirección completa y el enlace del mapa verificados. Inclúyalos también al mencionar una visita a la oficina o al terreno. No la convierta en preferencia por un piso.',
