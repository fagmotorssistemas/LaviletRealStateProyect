...
export function toneDirection(value: ToneSettings): string {
  ...
  const warmth = ['Use cortesía discreta y respetuosa. Vaya directamente a la respuesta, sin «con gusto», agradecimientos ni ofrecimientos de acompañamiento rutinarios. Salude cuando corresponda y reconozca una dificultad real con tacto.', 'Mantenga una calidez moderada: una cortesía breve es opcional cuando encaje, sin repetir fórmulas ni entusiasmo artificial.', 'Exprese mayor calidez mediante atención a la necesidad o inquietud que el cliente manifestó: atiéndala con información útil, sin repetir lo que acaba de decir. Reconozca expresamente una preocupación o dificultad real cuando ayude. No invente emociones, elogios ni agradecimientos automáticos.'][v.warmth]
